...
require (
	dubbo.apache.org/dubbo-go/v3 v3.1.1-0.20231030063950-3d97d4c07298
	github.com/dubbogo/grpc-go v1.42.10
	github.com/dubbogo/triple v1.2.2-rc3
	github.com/go-sql-driver/mysql v1.8.1
	gitlab.sy.soyoung.com/go/library v1.18.50
...
require (
	...
	gitlab.sy.soyoung.com/go/hprose v1.1.9 // indirect
	gitlab.sy.soyoung.com/go/nps-client v0.0.0-20221118092548-6462bcfe97d5 // indirect
